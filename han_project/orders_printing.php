...
<html>
    ...
    <a href="javascript:history.back()">Back</a>
        ...
        // var_dump($_POST);exit;
            ...
            $orders = mysqli_query($con, "SELECT orders.name, orders.address, orders.phone, orders.note, order_detail.*, product.ProductName as product_name FROM orders INNER JOIN order_detail ON Orders.id = order_detail.order_id INNER JOIN product ON product.ProductID = order_detail.product_id WHERE orders.id = " .$_POST['id_order']);
// var_dump($mysqli_error($orders));exit;
            $orders = mysqli_fetch_all($orders, MYSQLI_ASSOC);
        
        ?>
        <div id="order-detail-wrapper" style="
